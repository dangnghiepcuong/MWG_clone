    ...
    <div class="layout-slider">
        <div>
            ...
            <div class="layout-nav-slider" id="nav-slider-dual-banner">
                <div class="left" @click="navigateSlider('#frame-slider-dual-banner', 'left', 10, 2)">
                    <span class="icon material-symbols-outlined">arrow_back_ios</span>
                </div>
                <div class="right" @click="navigateSlider('#frame-slider-dual-banner', 'right', 10, 2)">
                    <span class="icon material-symbols-outlined">arrow_forward_ios</span>
                </div>
            </div>
        </div>
    </div>
    <div class="layout-campaign-cards">
